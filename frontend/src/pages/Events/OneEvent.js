      ...
      <div>
        ...
        <hr/>
          <table class="table">
            <thead>
              <tr>
                <th scope="col" style={{width: "200px", color: "black", backgroundColor: "white"}}>Name</th>
                <th scope="col" style={{width: "200px", color: "black", backgroundColor: "white"}}>Ratings</th>
                <th scope="col" style={{color: "black", backgroundColor: "white"}}>Reviews</th>
              </tr>
            </thead>
            <tbody>
              {reviews.map((review)=>(
                <tr>
                  <td style={{color: "black", backgroundColor: "white"}}>{review.userName}</td>
                  <td style={{color: "black", backgroundColor: "white"}}>{review.rating} Out Of 5</td>
                  <td style={{color: "black", backgroundColor: "white"}}>{review.reviewData}</td>
                </tr>
              ))}  
            </tbody>
          </table>
