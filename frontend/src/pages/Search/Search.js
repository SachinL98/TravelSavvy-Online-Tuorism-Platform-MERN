  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,_minmax(20rem,_1fr))] gap-8 gap-y-16 justify-items-center items-center">
      {filteredCars.map((car, index) => (
        <Link to={`/oneCar/${car._id}`} style={{ textDecoration: "none" }}>
...
function SideBarFilter(props) {
  return (
    <div
      className="sidebar lg:w-1/4 md:w-1/3 md:max-w-[18rem] w-full"
      data-visible={props.visible}
    >
      <div
        className="backdrop md:hidden w-full h-full bg-secondary-700 opacity-50"
    ...
    <>
      ...
      <div className="page md:flex md:gap-4">
        <SideBarFilter
          ...
          toggle={() => {
            toggleSidbar(sidebarVisible);
          }}
          LeftIcon={getIcon("funnel")}
        ></SideBarFilter>
